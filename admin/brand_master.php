...
$title = "Brand Master";
$pagename = "brand_master.php";
$module = "Brand Master";
$submodule = "Brand Master List";
$btn_name = "Save";
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4 mb-2">
                                            <strong><label for="cat_name" class="form-label"> Brand Name <span class="text-danger">*</span></label></strong>
                                            <input type="text" class="form-control form-control-sm" placeholder="Enter Brand Name" id="cat_name" name="cat_name" value="<?php echo $cat_name ?>" autocomplete="off" />
                                        </div>
